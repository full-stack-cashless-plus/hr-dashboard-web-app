...
export default {
  ...
  data() {
    return {
      ...
      columnDefs: [
        {
          headerName: "Excuse Start Time",
          field: "excuse_start_time",
          width: 250,
        },
        {
          headerName: "Excuse End Time",
          field: "excuse_end_time",
          width: 250,
        },
        {
          headerName: "Sender",
  ...
  computed: {
    itemsData() {
      return this.$store.state.hrReportManagement.itemsExcuse;
    },
    paginationPageSize() {
      ...
      this.$validator.validateAll().then((result) => {
        ...
        if (result) {
          ...
          this.$store
            ...
            .dispatch(
              "hrReportManagement/fetchItemsExcuseReport",
